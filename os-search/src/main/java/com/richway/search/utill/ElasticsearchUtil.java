package com.richway.search.utill;
...
public class ElasticsearchUtil {
    ...
    public static List searchAll(String index, String type) {
        SearchRequestBuilder srb = client.prepareSearch(index).setTypes(type);
        //查询所有
        SearchResponse getResponse = srb.setQuery(QueryBuilders.matchAllQuery()).execute().actionGet();
